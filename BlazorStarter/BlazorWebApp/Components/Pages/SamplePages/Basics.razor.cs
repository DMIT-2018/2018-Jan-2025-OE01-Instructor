...
namespace BlazorWebApp.Components.Pages.SamplePages
{
    public partial class Basics
    {
        ...
        private void TextSubmit()
        {
            ...
            //Must have brackets around the ternary operators when using string interpolation
            //Access the underlying value of a nullable datatype (one we added the ? to) with .Value
            //We can check if the value is null or not with .HasValue
